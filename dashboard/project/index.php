...
<div class="contents" style="margin-top: 100px;">
    ...
    <div class="container-fluid bg-clr-1" style="color:white;padding:10px"><h4> Add Project</h4></div>
    <div class="blog-content">
        ...
        <div style="box-shadow: inset 0px 0px 3px rgb(60 64 67 / 40%);background: #f3f3f3; border-radius:10px; padding: 10px;padding:20px;    width: 950px;" id="page-wrapper">
         ...
         <label class="pb-2">Project Category</label>
              <input class="form-control" type="text" name="project-cat" placeholder=" coffee, office, etc.">
          </div><br><br><br>
         
         <div class="form-group col-md-6 contact-info-div">
         <label class="pb-2">URL</label>
